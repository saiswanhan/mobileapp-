...
const msgtxt2 = '<p class="image"><img src= "img/whitebear.jpg" width=61px height=61px></p><p class="text" style="color: red;">WhiteBear Attack!(computer turn)</p>';
...
const msgtxt4 = '<p class="image"><img src= "img/whitebear.jpg" width=61px height=61px></p><p class="text animate__animated animate__bounceInDown">WhiteBear Win!!</p>';
const msgtxt5 = '<p class="image"><img src= "img/penguins.jpg" width=61px height=61px><img src= "img/whitebear.jpg" width= 61px height= 61px></p><p class="text animate__animated animate__fadeInTopRight">Draw!!</p>';
...
window.addEventListener("DOMContentLoaded",
    function(){
        squaresBox = document.getElementById("squaresBox");
        setMessage("pen-turn");
...
newgamebtn.addEventListener('click',function(){
    ...
    winningLine = null;
    squaresArray.forEach(function(square){
        square.classList.remove("js-pen-checked", "js-bear-checked", "js-pen_highLight", "js-bear_highLight", "js-unclickable");
    });
});
/*function resetGame() {
    squaresArray.forEach(function (square) {
